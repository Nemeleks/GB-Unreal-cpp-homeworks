...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_task1_t, stringdata0) + ofs), len 
...
QT_MOC_LITERAL(19, 19) // "on_mainMenu_clicked"
    ...
    "task1\0firstWindow\0\0on_mainMenu_clicked"
};
...
void task1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (task1::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&task1::firstWindow)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject task1::staticMetaObject = { {
    ...
    qt_meta_stringdata_task1.offsetsAndSize,
    qt_meta_data_task1,
    qt_static_metacall,
    nullptr,
